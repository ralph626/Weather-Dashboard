...
*/
var HISTORY = [];
//this gets the current day weather
...
//this gets the weather for the next 5 days
function getForecast() {
  ...
  $.get({
    ...
    success: function (data) {
      console.log(data);
      //this is for forecast. it was showing every 3 hours increments so I added 40 then divided the i by 8.
